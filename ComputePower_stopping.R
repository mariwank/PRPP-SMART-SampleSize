...
for (n in 1:length(sample_sizes)){
  ...
  if (power[n]  >= desired_power) {
    cat("Stopping: target power achieved")
    break
  }
...
# Example: 
folder_path <- paste0("/home/mariwank/Final_SampleSize_Results/Stopping/SimResults/Scenario", scenario, "/", subscenario, "/I", I, "/seed", seed_spec)
